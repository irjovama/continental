...
parent_category = Category.create(name: "Entrega de resultados")
sub_category = Category.create(name: "Conecta los logros con el equipo", parent: parent_category )
sub_category2 = Category.create(name: "Ejecuta con efectividad", parent: parent_category )
...
parent_category = Category.create(name: "Crea Vinculos genuinos")
sub_category = Category.create(name: "crea seguridad psicologica", parent: parent_category )
sub_category2 = Category.create(name: "Desarrolla confianza", parent: parent_category )
q1 = Question.create(title: "pregunta 1", category: sub_category, test: test, weight: 1)
q2 = Question.create(title: "pregunta 2", category: sub_category, test: test, weight: 1)
q3 = Question.create(title: "pregunta 3", category: sub_category2, test: test, weight: 1)
