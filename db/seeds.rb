...
q1 = Question.create(title: "pregunta 1", category: sub_category, test: test, weight: 1, option: option)
q2 = Question.create(title: "pregunta 2", category: sub_category, test: test, weight: 1, option: option)
q3 = Question.create(title: "pregunta 3", category: sub_category2, test: test, weight: 1, option: option2)
